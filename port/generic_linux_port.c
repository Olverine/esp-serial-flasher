...
int s_rts_signal = TIOCM_RTS;
int s_dtr_signal = TIOCM_DTR;
...
void loader_port_enter_bootloader(void)
{
    ...
    ioctl(serial,TIOCMBIS,&s_rts_signal);
    ioctl(serial,TIOCMBIS,&s_dtr_signal);
    loader_port_delay_ms(SERIAL_FLASHER_BOOT_HOLD_TIME_MS);
    ioctl(serial,TIOCMBIC,&s_dtr_signal);
    loader_port_delay_ms(SERIAL_FLASHER_BOOT_HOLD_TIME_MS);
    ioctl(serial,TIOCMBIC,&s_rts_signal);
    ioctl(serial,TIOCMBIS,&s_dtr_signal);
}
